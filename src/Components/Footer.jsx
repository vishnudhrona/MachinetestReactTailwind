      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-950">Company</p>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="#"
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-950">Helpful Links</p>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="#"
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-950">Legal</p>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="#"
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-950">Downloads</p>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="#"
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            ...
            <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
              <li>
                <a href="#" className="text-gray-950 transition hover:opacity-75">
                  Terms &amp; Conditions
                </a>
              </li>
              <li>
